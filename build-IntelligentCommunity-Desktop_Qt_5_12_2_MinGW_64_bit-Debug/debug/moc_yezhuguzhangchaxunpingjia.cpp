...
void Yezhuguzhangchaxunpingjia::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Yezhuguzhangchaxunpingjia *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Yezhuguzhangchaxunpingjia::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Yezhuguzhangchaxunpingjia.data,
    qt_meta_data_Yezhuguzhangchaxunpingjia,
    qt_static_metacall,
    nullptr,
    nullptr
} };
