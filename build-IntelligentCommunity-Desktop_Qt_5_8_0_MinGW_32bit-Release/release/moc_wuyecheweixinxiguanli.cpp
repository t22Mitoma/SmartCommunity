...
void Wuyecheweixinxiguanli::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Wuyecheweixinxiguanli *_t = static_cast<Wuyecheweixinxiguanli *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject Wuyecheweixinxiguanli::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Wuyecheweixinxiguanli.data,
      qt_meta_data_Wuyecheweixinxiguanli,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Wuyecheweixinxiguanli::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Wuyecheweixinxiguanli.stringdata0))
        return static_cast<void*>(const_cast< Wuyecheweixinxiguanli*>(this));
