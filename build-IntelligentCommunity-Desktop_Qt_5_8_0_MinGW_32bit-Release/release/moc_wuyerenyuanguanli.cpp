...
QT_MOC_LITERAL(5, 89, 23), // "on_pushButton_5_clicked"
QT_MOC_LITERAL(6, 113, 23) // "on_pushButton_6_clicked"

    },
    "Wuyerenyuanguanli\0on_pushButton_clicked\0"
...
void Wuyerenyuanguanli::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Wuyerenyuanguanli *_t = static_cast<Wuyerenyuanguanli *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject Wuyerenyuanguanli::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Wuyerenyuanguanli.data,
      qt_meta_data_Wuyerenyuanguanli,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Wuyerenyuanguanli::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Wuyerenyuanguanli.stringdata0))
        return static_cast<void*>(const_cast< Wuyerenyuanguanli*>(this));
