...
void Wuyeweixiuguanli::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Wuyeweixiuguanli *_t = static_cast<Wuyeweixiuguanli *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject Wuyeweixiuguanli::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Wuyeweixiuguanli.data,
      qt_meta_data_Wuyeweixiuguanli,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Wuyeweixiuguanli::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Wuyeweixiuguanli.stringdata0))
        return static_cast<void*>(const_cast< Wuyeweixiuguanli*>(this));
